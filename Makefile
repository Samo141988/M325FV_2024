...
ARCH            ?= arm64
CROSS_COMPILE   ?= ../toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-androidkernel-
...
CC		= ../toolchain/clang-r383902/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE	?= ../toolchain/clang-r383902/bin/aarch64-linux-gnu-
